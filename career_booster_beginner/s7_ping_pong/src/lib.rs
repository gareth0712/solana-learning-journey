...
// TODO: Modify the program so that the ping program simply invokes the pong program with a single instruction that returns a “pong” string.
...
pub fn process_instruction(
  ...
  msg!("transfering {} lamports from {} to {}", lamports, from_account.key, to_account.key);
